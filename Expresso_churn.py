...
st.markdown("<h3 style = 'margin: -25px; color: #45474B; text-align: center;font-family: Arial, Helvetica, sans-serif; '> BUILT BY CHUKWUDI ONOVO</h3>", unsafe_allow_html= True)
st.image('img2.jpeg', width = 400)
